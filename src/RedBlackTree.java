...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    protected static class Node<T> {
        ...
        public Node(T data) { this.data = data; color = Color.RED; isBlack = false;}
        /**
    ...
    public boolean insert(T data) throws NullPointerException, IllegalArgumentException {
        ...
        if(root == null) { root = newNode; size++; root.color = Color.BLACK; root.isBlack = true;  return true; } // add first node to an empty tree
        else{
    ...
    //At the end of the insert method, make sure root node is black

    /*takes a reference to a newly added red node as its only parameter.
     Note that this method may also be called recursively, in which case the input parameter
     may reference a different red node in the tree that potentially has a red parent node.
     The job of this enforceRBTreePropertiesAfterInsert method is to resolve a red child under
     a red parent red black tree property violations that are introduced by inserting new nodes
     into a red black tree. While doing so, all other red black tree properties must also be preserved.
     */

    //Called from insertHelper
...
//        while (current.parent.color == Color.RED){
    ...
    private State getState(Node<T> node){
